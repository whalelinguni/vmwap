...
Packing into an exe currently, elevation is the issue. Script has been fully tested and works without issues elevated. Just debugging some oddities when compiled to exe. 
